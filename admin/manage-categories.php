...
//fetch categoriesn from database
...
<section class="dashboard">
    ...
    <?php elseif (isset($_SESSION['delete-category-success'])) : //shows if deleted category was successfully
    ?>
        <div class="alert_message success container">
            <p><?php
    ...
    <?php elseif (isset($_SESSION['delete-category-success'])) : //shows if  category was not deleted successfully
    ?>
        <div class="alert_message error container">
            <p><?php
                echo $_SESSION['delete-category-success'];
