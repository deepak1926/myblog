...
<section class="dashboard">
    <?php
    if (isset($_SESSION['add-post-success'])) : //shows if add post was successfully
    ?>
    ...
    <?php
    elseif (isset($_SESSION['edit-post-success'])) : //shows if post  was edited successfully
    ?>
        <div class="alert_message success container">
            <p><?php
    ...
    <?php
    elseif (isset($_SESSION['edit-post'])) : //shows if add post was not edited successfully
    ?>
        ...
        <?php
    elseif (isset($_SESSION['delete-post-success'])) : //shows if post  was deleted successfully
    ?>
        <div class="alert_message success container">
            <p><?php
